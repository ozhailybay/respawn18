...
export const LEVELS = [
  ...
  { level: 2, xpRequired: 100, title: 'Новичок', color: '#66BB6A' },
  { level: 3, xpRequired: 200, title: 'Активный участник', color: '#42A5F5' },
  { level: 4, xpRequired: 300, title: 'Энтузиаст', color: '#7E57C2' },
  { level: 5, xpRequired: 400, title: 'Легенда Respawn', color: 'gold' }
];
