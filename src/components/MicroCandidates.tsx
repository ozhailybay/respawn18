  ...
  const demoUserData: Record<string, UserData> = {
    'student1': {
      ...
      skills: [
        ...
        { name: 'html', level: 'advanced', category: 'technical' },
        { name: 'css', level: 'advanced', category: 'technical' }
      ],
      education: [{
        degree: 'Bachelor',
      ...
      experience: [{
        ...
        achievements: ['Improved app performance by 40%', 'Implemented new UI components'],
    ...
    'student2': {
      ...
      skills: [
        { name: 'html', level: 'advanced', category: 'technical' },
        { name: 'css', level: 'advanced', category: 'technical' },
        { name: 'design', level: 'intermediate', category: 'soft' },
        { name: 'figma', level: 'intermediate', category: 'technical' },
        { name: 'ui/ux', level: 'intermediate', category: 'technical' }
      ],
      education: [{
        degree: 'Bachelor',
        field: 'Design',
        ...
        endDate: '2024-06-01',
        gpa: 3.9,
        highlights: ['Design Award Winner', 'Student Council Member'],
        relevantCourses: ['UI/UX Design', 'Graphic Design', 'Web Design']
      }],
      experience: [{
        ...
        endDate: '2023-12-01',
        current: false,
        description: 'Worked on various design projects for clients',
        achievements: ['Completed 15+ design projects', 'Maintained 4.8/5 client rating'],
    ...
    'student3': {
      ...
      skills: [
        ...
        { name: 'data analysis', level: 'beginner', category: 'technical' },
      ...
      education: [{
        ...
        endDate: '2026-06-01',
        gpa: 3.5,
        highlights: ['First Year Student'],
        relevantCourses: ['Programming Basics', 'Mathematics', 'Information Systems']
      }],
      experience: [],
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4 flex items-center">
                            <img 
                              ...
                              src={application.student.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(application.student.displayName || 'User')}&size=150&background=random`}
