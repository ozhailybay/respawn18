      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden p-6">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
            ...
            <span className="px-3 py-1 bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-200 rounded-full text-sm font-medium">
              Тестовый режим
            </span>
          </div>
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            {MINIMAL_DEMO_JOBS.map(job => (
              <div key={job.id} className="py-4">
                ...
                <div className="mt-3">
                  <button className="px-4 py-2 bg-black hover:bg-gray-800 dark:bg-white dark:hover:bg-gray-200 text-white dark:text-black rounded-lg text-sm transition duration-150">
                    Подать заявку
                  </button>
                </div>
              </div>
