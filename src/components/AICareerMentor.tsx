...
Keep the tone friendly and encouraging. Format your response with clear sections and bullet points where appropriate.`;
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center bg-white dark:bg-black px-4 relative overflow-hidden transition-all duration-700 ${
      isVisible ? 'opacity-100' : 'opacity-0'
    }`}>
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-black/5 dark:bg-white/5 rounded-full filter blur-xl opacity-20 animate-blob"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gray-500/5 dark:bg-gray-400/5 rounded-full filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-black/3 dark:bg-white/3 rounded-full filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
